...
import websiteDevIcon from '../../assets/json/website-dev.json';
import softwareDevIcon from '../../assets/json/software-dev.json'; 
import websiteDesignIcon from '../../assets/json/website-design.json'; 
import eCommerceDevIcon from '../../assets/json/eCommerce-dev.json'; 
import fullStackIcon from '../../assets/json/full-stack.json'; 
import hrPortalIcon from '../../assets/json/hr-portal.json';
